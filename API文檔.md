...
## 目錄：
[1、根據經緯度獲取位置詳情](#1根據經緯度獲取位置詳情) 
[2、獲取食品分類列表](#2獲取食品分類列表) 
[3、根據經緯度獲取商鋪列表](#3根據經緯度獲取商鋪列表) 
[4、根據經緯度和關鍵字搜索商鋪列表](#4根據經緯度和關鍵字搜索商鋪列表) 
[5、獲取一次性驗證碼](#5獲取一次性驗證碼) 
[6、用戶名密碼登陸](#6用戶名密碼登陸) 
[7、發送短信驗證碼](#7發送短信驗證碼) 
[8、手機號驗證碼登陸](#8手機號驗證碼登陸) 
[9、根據會話獲取用戶信息](#9根據會話獲取用戶信息) 
[10、用戶登出](#10用戶登出) 
...
### 返回示例：
	{
	  ...
	  data: [
              {
                name: "肯德基",
                address: "上海市寶山區淞寶路155弄18號星月國際商務廣場1層",
                id: 1,
                latitude: 31.38098,
                longitude: 121.50146,
                location: [
                ...
                supports: [
                  {
                    description: "已加入“外賣保”計劃，食品安全有保障",
                    icon_color: "999999",
                    icon_name: "保",
                    id: 7,
                    name: "外賣保",
      ...
      "data": [
        {
          ...
          "supports": [
            ...
            {
              "description": "該商家支持開發票，請在下單時填寫好發票抬頭",
              "icon_color": "999999",
              "icon_name": "票",
              "id": 4,
              "name": "開發票",
        ...
        {
          "name": "test",
          "address": "浙江省杭州市余杭區高教路阿裡巴巴西溪園區2號樓",
          "id": 1271,
          "latitude": 30.27817,
