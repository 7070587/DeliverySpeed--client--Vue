    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">月售{{info.sellCount}}單</span>
          <span class="shop-message-detail">{{info.description}}</span>
          <span class="shop-message-detail">約{{info.deliveryTime}}分鐘</span>
          <span class="shop-message-detail">距離{{info.distance}}</span>
        </div>
      </div>
    </div>

    <!--避免在沒有數據的時候取去解析數據：v-if="info.supports，表示info.supports有值-->
