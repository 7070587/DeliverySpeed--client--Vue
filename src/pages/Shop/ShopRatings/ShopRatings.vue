      ...
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="delivery-wrapper">
            <span class="title">&emsp;送達時間<span class="delivery">{{info.deliveryTime}}分鐘</span></span>
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          ...
          <span class="block negative" :class="{active: selectType === 1}" @click="setSelectType(1)">
            不滿意<span class="count">{{ratings.length - positiveSize}}</span>
          </span>
...
<script>
  ...
  import BScroll from 'better-scroll'
    ...
    data() {
		  return {
		    onlyShowText: true,  // 是否只顯示有文本內容的評價
        selectType: 2        // 只選擇的評價類型： 0滿意、1不滿意、2全部
      };
    },
    mounted() {
    ...
    computed: {
      ...
      filterRatings() {
        // 影響的數據有哪些？得到相關的數據
        const {ratings, onlyShowText, selectType} = this;   // 總數組
